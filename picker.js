...
var elPickColor = document.querySelector('[nameId="pickerColor"]');
...
var picker = 
{
	...
	init: function () 
	{	
		var th = elPickColor.querySelector('[nameId="arrows"]');
		var bk = elPickColor.querySelector('[nameId="block_picker"]');
		var circle = elPickColor.querySelector('[nameId="circle"]');
		var line = elPickColor.querySelector('[nameId="line"]');
		
		var s = {h:180, w:20, th: th, bk: bk, line: line};
		/*
		...
		*/
		...
		picker.out_color = elPickColor.querySelector('[nameId="out_color"]');
	}
};
